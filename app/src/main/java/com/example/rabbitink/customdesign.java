...
public class customdesign extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customdesign);
        ...
        Button email = (Button) findViewById(R.id.sendLogo);
        email.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sendEmail.putExtra(android.content.Intent.EXTRA_EMAIL, new String[]{"ercantekoglan@gmail.com"});
